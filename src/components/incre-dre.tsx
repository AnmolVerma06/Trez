...
export default function IncreDre({ quantity = 1 }: { quantity?: number }) {
  ...
  return (
    <div className="inc-dec flex items-center gap-2">
        ...
        <input className="w-6 h-auto outline-none bg-transparent text-base mg:text-lg leading-none text-title dark:text-white text-center" type="text" value={count} readOnly title="Quantity" placeholder="Quantity"/>
