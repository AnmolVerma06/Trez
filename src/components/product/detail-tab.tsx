  ...
  return (
    <div className="max-w-[985px] mx-auto">
        ...
        <div id="content" className="mt-5 sm:mt-8 lg:mt-12 mx-0 sm:mr-5 md:mr-8 lg:mr-12">
            {activeTab === 1 && 
                <div>
                    <p className="sm:text-lg">{product?.description || 'No description available.'}</p>
                    <ul className="mt-4 sm:mt-6 grid gap-4 sm:gap-5 sm:text-lg leading-none">
                        <li>Leather : From Japan</li>
                        <li>Brand : {product?.brand || 'Navana'}</li>
                        <li>Weight : 1kg</li>
                        <li>Color : Wooden , White , Blue , Orange</li>
                    </ul>
                </div>
            }
            {activeTab === 2 && vendor &&
                <div>
                    <div className="max-w-[680px] flex items-start justify-between gap-y-8 gap-x-10 flex-wrap">
                        <div>
                            ...
                            <h4 className="font-medium mt-2 sm:mt-3 text-xl sm:text-2xl leading-none">{vendor.name}</h4>
                            <ul className="mt-4 sm:mt-6 grid gap-3 sm:text-lg">
                                <li>Shop : {vendor.shop}</li>
                                <li>Mail : {vendor.mail}</li>
                                <li>Call : {vendor.call}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            {activeTab === 3 &&
                <div>
                    <div className="max-w-[905px] flex items-start xl:justify-between gap-8 flex-wrap">
                        {reviews.length > 0 ? reviews.map((item: {name: string; desc: string}, index: number)=>(
