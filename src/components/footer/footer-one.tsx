                ...
                <div className="container-fluid">
                    ...
                    <div className="max-w-[1722px] mx-auto flex items-start justify-between gap-10 s-pb-100 flex-wrap lg:flex-nowrap footer-wrapper">
                        ...
                        <div className="lg:max-w-[522px] w-full sm:text-center -order-1 lg:order-none">
                            ...
                            <p className="mt-4 text-white-light max-w-[522px] sm:mx-auto">Trez is a modern furniture template for an eCommerce website designed to help you create an impressive online store for your furniture or home decor business. </p>
                    ...
                    <div className="max-w-[1722px] mx-auto border-t border-white border-opacity-10 py-5 md:py-7 text-center">
                        <p className="text-white-light inline-flex align-middle">© {new Date().getFullYear()} Trez Develop with <FaHeart className="fa-solid fa-heart mx-1 text-red-500"></FaHeart>  By <Link to="https://shreethemes.in/" target="_blank" className='ms-1'>Shreethemes</Link></p>
                    </div>
                </div>
            </div>
        </div>
